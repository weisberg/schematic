...
| 11 | `js/commands.js` | Shared command definitions plus ribbon, quick-access, overflow, and command-palette bindings |
| 12 | `js/context-menu.js` | Node, edge, and blank-canvas context menus |
| 13 | `js/bootstrap.js` | Starter data, initialization sequence, and the `window.__T` test/debug surface |
